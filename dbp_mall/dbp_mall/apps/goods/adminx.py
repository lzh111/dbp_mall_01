...
class GlobalSettings(object):
    """xadmin的全局配置"""
    site_title = "DBP商城运营管理系统"  # 设置站点标题
    site_footer = "DBP商城集团有限公司"  # 设置站点的页脚
...
class SKUAdmin(object):
    ...
    list_editable = ['price', 'stock','default_image']
...
class SKUImageAdmin(object):
    def save_model(self, request, obj, form, change):
        ...
        if not sku.default_image:
            sku.default_image = obj.image.url
            sku.save()
...
# xadmin.site.register(models.SKUImageAdmin)
