var vm = new Vue({
	...
	mounted: function(){  //页面加载完就会 执行下边的操作 发起请求
		...
		this.generate_image_code();  //生成验证码图片并为src绑定一个属性
				...
				.then(response => {
					...
					var t = setInterval(() => {
						if (num == 1) {
							...
							// console.log('dian ji cheng gong')
						}
					}, 1000, 60)
				})
				.catch(error => {
